...
class OnboardingFirstVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        subLabel.text = "Our app is designed to empower you with the tools you need to succeed in the trading world. Begin your journey by exploring the key features we offer."
        subLabel.font = .systemFont(ofSize: 16, weight: .bold)
        ...
        NSLayoutConstraint.activate([
            ...
            subLabel.topAnchor.constraint(equalTo: onboardImage.bottomAnchor, constant: 35),
            ...
            subLabel.heightAnchor.constraint(equalToConstant: 96),
